/**
 * Validação para Anexo VIII
 * Verifica se todos os campos obrigatórios estão preenchidos
 */
function validateAnexoVIII() {
...
window.validateAnexoVIII = validateAnexoVIII;
window.clearAnexoVIIIForm = clearAnexoVIIIForm;
