/**
 * Validação para Anexo IX
 * Verifica se todos os campos obrigatórios estão preenchidos
 */
function validateAnexoIX() {
...
window.validateAnexoIX = validateAnexoIX;
window.clearAnexoIXForm = clearAnexoIXForm;
