/**
 * Validação para Anexo VII
 * Verifica se todos os campos obrigatórios estão preenchidos
 */
function validateAnexoVII() {
...
window.validateAnexoVII = validateAnexoVII;
window.clearAnexoVIIForm = clearAnexoVIIForm;
